...
def evaluate_main(model, evaluator, loader, input_size, num_classes, whole = False, recurrence = 1, type = 'val'):
    ...
    for index, batch in enumerate(loader):
        ...
        if type == 'test':
            ...
            seg_pre = id2trainId(seg_pred, id_to_trainid, reverse=True)
            # print(seg_pre)  #(256,256)
            output_im = PILImage.fromarray(seg_pre)
            # print("-------------------------------------------------")
            # print(output_im)              #<PIL.Image.Image image mode=L size=256x256 at 0x7FB50E0720F0>
