...
# DATA_LIST_VAL_PATH_NEW = 'dataset/list/cityscapes/val_new.lst'
# IGNORE_LABEL = 255
# INPUT_SIZE = '512,512'
...
class TrainOptions():
    def initialize(self):
        ...
        parser.add_argument("--cwd_f", type=str2bool, default='True')
        parser.add_argument("--cwd_s", type=str2bool, default='True')
        parser.add_argument('--lambda-cwd', type=float, default=35.0, help='lambda_cwd')

        parser.add_argument("--pa", type=str2bool, default='True')
        parser.add_argument('--lambda-pa', type=float, default=0.5, help='lambda_pa')
        ...
        parser.add_argument("--lambda-adv-new", type=float, default=0.1, help="lambda_adv")
        # save params
        parser.add_argument("--save-name", type=str, default='/log')
