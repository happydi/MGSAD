...
from mobilenet_WHDLD.mobilenetv2 import mobilenetv2
...
class PSPNet(nn.Module):
    def __init__(self, num_classes, downsample_factor, pretrained=True, aux_branch=True):
        ...
        self.pspmodule = _PSPModule(out_channel, pool_sizes=[1, 2, 3, 6], norm_layer=norm_layer)
        self.head = nn.Conv2d(out_channel // 4, num_classes, kernel_size=1)
    ...
    def forward(self, x):
        ...
        x_dsn = self.auxiliary_branch(x_aux)
