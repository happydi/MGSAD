...
if DATASET=='WHDLD':
    NUM_CLASSES = 6
    DATA_DIRECTORY = '/private/yangZY/Code/dataset/WHDLD'
    DATA_LIST_TRAIN_PATH = 'dataset/list/WHDLD/train.lst'
    DATA_LIST_VAL_PATH = 'dataset/list/WHDLD/val.lst'
    DATA_LIST_TEST_PATH = 'dataset/list/WHDLD/test.lst'
    INPUT_SIZE = '256,256'
if DATASET=='ISPRS':
    NUM_CLASSES = 5
    DATA_DIRECTORY = '/private/Donghui/CodeMain/dataset/ISPRS_Potsdam_512x'
    DATA_LIST_TRAIN_PATH = 'dataset/list/ISPRS/train.lst'
    DATA_LIST_VAL_PATH = 'dataset/list/ISPRS/val.lst'
    DATA_LIST_TEST_PATH = 'dataset/list/ISPRS/test.lst'
    INPUT_SIZE = '512,512'
# init params
T_CKPT = 'ckpt/ckpt_WHDLD/WHDLD_39999_T.pth'
# S_CKPT = './ckpt/resnet18-imagenet.pth'
# T_CKPT = './ckpt/teacher_city.pth'
# S_CKPT = './ckpt/path/to/save/city_19999_0.6381804887471665_G.pth'
...
class TrainOptions():
    def initialize(self):
        ...
        # parser.add_argument("--data-listvalnew", type=str, default=DATA_LIST_VAL_PATH_NEW, help="Path to the file listing the images in the dataset.")
        # parser.add_argument("--ignore-label", type=int, default=IGNORE_LABEL, help="The index of the label to ignore during the training.")
        parser.add_argument("--input_size", type=str, default=INPUT_SIZE, help="Comma-separated string with height and width of images.")
        ...
        parser.add_argument("--pi", type=str2bool, default='True')
        parser.add_argument("--lambda-pi", type=float, default=10.0, help="lambda_pi")

        parser.add_argument("--adv-new", type=str2bool, default='True')
        parser.add_argument("--lambda-adv-new", type=float, default=0.001, help="lambda_adv")
        # save params
        ...
        parser.add_argument("--save-visualpath",type=str,default='log_dir')
